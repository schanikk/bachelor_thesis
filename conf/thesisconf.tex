...
\newcommand{\mytitle}{Anylzing Political Discourse \\ on \\ Social Media Platforms \\ using \\ Natural Language Processing}
\title{\mytitle}

% title without line breaks
\newcommand{\mytitleplain}{Analyzing Political Discourse on Social Media Platforms using Natural Language Processing}
\titleplain{\mytitleplain}

% authorname
\newcommand{\authorname}{Till N. Schaland}

% specifiy Date of submission
\dateofsubmission{ 1.2.2025 }
...
\supervisonby{Seid Muhie Yimam, Universität Hamburg}

% who's part of your comittee?
\comittee{%
  1\textsuperscript{st} Examiner: Prof.\ Dr.\ Chris Biemann, Universität Hamburg \\%
  2\textsuperscript{nd} Examiner: Dr.\ Seid Muhie Yimam, Universität Hamburg \\%
}%
%% OVERRIDE defaults 
